          ...
          <form className='col-span-7' onSubmit={onSubmitSearch}>
            ...
            <div className='relative'>
              ...
              <input
                ...
                required
              />
              <Button type='submit' primary className='absolute bottom-2.5 right-2.5'>
                <AiOutlineSearch />
              </Button>
            </div>
          </form>
          ...
          <div className='flex-center col-span-1 justify-self-end'>
                  ...
                  {purchasesInCart && purchasesInCart.length > 0 ? (
                    <div className='p-2'>
                      ...
                      {purchasesInCart.slice(0, MAX_PURCHASES).map((item) => (
                        <div key={item._id} className='flex py-2 hover:bg-gray-100'>
                          ...
                          <div className='ml-2 flex-shrink-0'>
                            <span className='text-primary'>đ{formatCurrency(item.product.price)}</span>
                          </div>
                        </div>
                      ))}
                      ...
                      <div className='mt-6 flex items-center justify-between'>
                        ...
                        <Link to={path.cart} className='bg-primary rounded-sm p-2 text-white hover:bg-opacity-80'>
                          Xem giỏ hàng
                        </Link>
                      </div>
                    </div>
            ...
            >
              <Link to='/cart' className='relative'>
                ...
                {purchasesInCart && (
                  <span className='text-primary absolute -top-2 left-3 rounded-full bg-white px-[9px] py-[1px] text-xs'>
